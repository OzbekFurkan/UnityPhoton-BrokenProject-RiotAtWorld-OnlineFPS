...
public class PickUpController_pistol : MonoBehaviour
{
    ...
    private void Update()
    {
        if (!gamemodescript.isdead)
        {
            ...
            gunContainer = GameObject.FindGameObjectWithTag("mainplayer").transform.GetChild(1).GetChild(0).GetChild(3).GetChild(0);
